    ...
    >
      <div className="max-w-7xl mx-auto flex justify-between items-center px-8 md:px-12">
        ...
        <div className="hidden md:flex items-center space-x-12">
          ...
          <motion.a
            href="/path-to-your-profile.pdf" // Replace with your actual PDF path
            download="Green_Decors_Profile.pdf"
          ...
          >
            ...
            {/* Pulsing indicator to grab attention */}
       
          </motion.a>
        </div>

        {/* 4. Right Side (Utility & Mobile Toggle) */}
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          ...
          >
            ...
            <a  target="_blank"
              href="/profile.pdf" 
              className="mt-8 bg-emerald-900 text-white px-8 py-4 rounded-full text-xs font-bold uppercase tracking-widest"
            >
